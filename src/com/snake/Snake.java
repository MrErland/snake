...
public class Snake {
    ...
    public void reset() {
        ...
        snakeBody.add(new Block(beginPos.row + 1, beginPos.col));
        snakeBody.add(new Block(beginPos.row + 2, beginPos.col));
    ...
    private boolean isCollision(Block addPos) {
        if (addPos.row < 0 || addPos.row > Row - 1
                || addPos.col < 0 || addPos.col > Column - 1)
            return true;
        // 如果是墙壁返回true
